...
private:
	...
	//determine is descriptor and detector same object
	bool DETDSCFLAG = false;
...
public:
	...
	ProgramFlowFacade(DetectorOptions *detectorOptions_, Detector *detector_, DescriptorOptions *descriptorOptions_,
					  ...
					  DescriptionsMatcherOptions *descMatcherOptions_, DescriptionsMatcher *descMatcher_, int kpointsLimit, bool DETDSCFLAG)
